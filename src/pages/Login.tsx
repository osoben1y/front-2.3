      ...
      <div className="backdrop-blur-xl bg-white/30 dark:bg-white/10 w-full max-w-md rounded-2xl shadow-2xl p-8 sm:p-10 transition-all duration-300 border border-white/20">
        ...
        <form className="space-y-6">
          ...
          <div className="text-right">
            <button type="button" className=" text-gray-900 dark:text-white hover:underline text-sm">
              Forgot password?
            </button>
          </div>
          ...
          <div className="text-center">
            <Link
              to="/"
              className="inline-block mt-4 text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 transition"
            >
              Go back
            </Link>
          </div>
